...
**Oppure:**
- I processi vengono applicati allo stesso intervallo di altezza sui diversi VTool. ### :arrow_down:[Download (per Windows)](GradientMixToolV1.zip)
### Istruzioni per l'uso
#### 1. [Scarica il software](GradientMixToolV1.zip) e decomprimilo sul tuo PC (un solo file exe).
