...
Вы можете увидеть, какие команды Gcode были добавлены в окне ***export***
![](4.jpg)
Нажмите кнопку ВВЕРХ и ВНИЗ на полосе прокрутки, чтобы быстро перейти к предыдущей/следующей позиции, в которую вставляется G-код.
![](5.jpg)
