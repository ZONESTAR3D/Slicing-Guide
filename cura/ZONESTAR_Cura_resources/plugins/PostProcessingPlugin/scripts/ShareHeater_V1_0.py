...
class ShareHeater_V1_0(Script):
    def __init__(self):
        super().__init__()
        
    def getSettingDataString(self):
        return """{
            "name": "ZONESTAR Share Heater Plugin V1.0",
            "key": "ShareHeater_V1_0",
            "metadata": {},
            "version": 2,
            "settings":
            {
                "remove_M104M109":
                {
                    "label": "Remove Unexpected M104&M109",
    ...
    def execute(self, data):
        ...
        #logo_file.write(";;; This file is created by ZONESTAR Share Heater Plugin V1.0\n")
        #logo_file.write(";;; Website: www.zonestar3d.com\n")
        #logo_file.write(";\n")
            ...
            for line in lines:
                ...
                if line.startswith("M") and "M109" in line:
                    if bFindM109 == 1 and totallayers - curlayer > 1:
                       ...
                       if self.getSettingValueByKey("remove_M104M109"):
                           #remove this line
