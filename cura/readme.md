...
- **Step 2**:  :arrow_down: Download [**Zonestar 3D Printer Profiles.**](./ZONESTAR_Cura_resources.zip) *<-click here and then click "download" button to download [:movie_camera:](downloadzip.gif), the last updata on 2022-08-15.*. 
