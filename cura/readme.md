...
- Download [:arrow_down: **Zonestar 3D Printer Profiles.**](./ZONESTAR_Cura_Resources.zip) *:point_left:Click here and then click "download" button. the last updata on 2023-04-25*.   
![](downloadzip.gif)  
