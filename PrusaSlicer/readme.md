...
## 3. Choose system presets according to your printer, hotend and the colors you want to print 
...
![](pic/slicing1C-2.png)
#### 3. Choose print filament type
![](pic/slicing1C-3.png)
#### 4. If need, you can resize, cut, rotate the 3d model 
![](pic/slicing1C-4.png)  
...
#### 6 Slicing
![](pic/slicing1C-6.png)  
#### 7 Preview the sliced result (gcode file) and then save to gcode file to your PC and then copy to SD card
![](pic/slicing1C-7.png)  
...
### 3 Choose print filament type - PLA and set filament color
![](pic/slicingM4-3.png)
### 4 Assign extruders to different parts
![](pic/slicingM4-4.png)
### 5 If need, you can resize, cut, rotate the 3d model 
![](pic/slicingM4-5.png)  
### 6 Set the print settings: layer height, print speed, support, infill, etc.
![](pic/slicingM4-6.png)  
...
- [**PrusaSlicer introduction**](https://www.prusa3d.com/page/prusaslicer_424/)
- [**Slic3r User Manuual**](https://manual.slic3r.org/)
### 7 Set parameters for "wipe tower"
