...
**Be sure to know whether the hot end you use is M4 (4IN-1-OUT mix color hot end) or E4 (4-IN-1-OUT Non-mix color hot end). If you print the gcode file generated by using E4 hot end sliced on M4 hot end, it is likely to cause the hot end to be blocked, vice versa.**  
