...
1. The usual ***"Retraction"*** refers to when printing fine threads of the same color, when the printer moves from one point to another, the fine threads are pulled back a little distance to reduce the outflow of the fine thread nozzle. :warning: 1. *Retraction length* should be less than 10mm for E4 Hot end.     
